    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '🧨 jest 实践指南', link: 'https://github.yanhaixiang.com/jest-tutorial/#%E6%B5%8B%E8%AF%95%E9%9A%BE%E7%82%B9' },
    ...
    items: [
      {
        text: "常用工具",
        items: [
          { text: '颜色表', link: 'https://www.toolscat.com/ui/color/yansebiao' },
