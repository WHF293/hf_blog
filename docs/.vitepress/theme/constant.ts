...
const homeInfo = [
    { title: "学习源码", details: "主要记录了自己源码学习的一些记录", url: "/source/", icon: "🛠️" },
    { title: "工作日常", details: "记录自己在工作或学习中遇到的问题或者踩到的坑", url: "/work/", icon: "✨" },
    { title: "博客推荐", details: "记录一些平时看到的博客文章", icon: "🧶", url: "/docs/博客推荐" },
    { title: "Vue 笔记", details: "主要记录了学习 vue3 以及学习其周边库过程中遇到的一些知识点", url: "/vue3/", icon: "🏮" },
    { title: "React 笔记", details: "主要记录了学习 react 以及学习其周边库过程中遇到的一些知识点", url: "/react/", icon: "🔮" },
    { title: "面试题解", details: "b 站观看各种模拟面试视频或者根据掘金上大佬们分享面经所记录的笔记", icon: "🎖️", url: "/interview/" },
] as Feature[];
